...
For example for the domain integra.lan with IP 10.20.102.66 run the following command. 
```ruby
zmprov md domain.local zimbraVirtualHostname `hostname -f` zimbraVirtualIPAddress 10.20.102.66
